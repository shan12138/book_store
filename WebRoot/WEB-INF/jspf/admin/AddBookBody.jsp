...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
 <jsp:useBean id="book" scope="request" class="com.hgd.ebp.domain.Book" />
    <form:form modelAttribute="book" action="./AddBookCtrl" method="POST" class='ticketForm'
    onsubmit="return checkAddBookForm(this)">
        ...
        <table class='Form' align='center'>
           ...
           <tr>
            ...
            <tr>
                ...
                <td>
                	<input type=submit value='添加' style="width:70px;background:#ccffff"/>
